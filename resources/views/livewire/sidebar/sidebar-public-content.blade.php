<div class="grid grid-rows-[auto_1fr] h-screen grow bg-zinc-50 dark:bg-zinc-800">
    <a wire:navigate class="flex h-16 px-6 shrink-0 items-center bg-zinc-800 border-b border-zinc-900 shadow-sm shadow-black/20" href="{{ route('public-infos', ['election' => $electionID]) }}">
