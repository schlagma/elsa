    ...
    <div class="mt-6 mb-12">
        <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6">
            <div>
                ...
                <input type="text" wire:model="firstname" class="w-full" disabled>
            </div>
            <div>
                <label>{{ __('admin.lastname') }}</label>
                <input type="text" wire:model="lastname" class="w-full" disabled>
            </div>
            <div>
                <label>{{ __('admin.emailAddress') }}</label>
                <input type="text" wire:model="email" class="w-full" disabled>
            </div>
            <div>
            <label>{{ __('admin.faculty') }}</label>
                <select wire:model="faculty" disabled>
            ...
            <div>
                ...
                <select wire:model="course" disabled>
        ...
        <div class="mt-6 grid sm:grid-cols-2 xl:grid-cols-3 gap-6">
            <div>
                ...
                <select wire:model.change="election" disabled>
            ...
            <div>
                ...
                <select wire:model.change="committee" disabled>
            ...
            <div>
                ...
                <select wire:model="list" disabled>
