<div class="flex h-16 shrink-0 items-center gap-x-4 border-b border-zinc-900 bg-zinc-800 px-4 shadow-sm shadow-black/30 sm:gap-x-6 sm:px-6 lg:px-8 z-10 print:hidden">
    ...
    <div class="flex items-center gap-x-6 ml-auto">
        ...
        <div class="relative">
            ...
            <div class="absolute right-0 z-10 mt-4 w-64 origin-top-right divide-y divide-zinc-200 dark:divide-zinc-700 rounded-md bg-white dark:bg-zinc-800 ring-1 shadow-lg ring-black/5 dark:ring-zinc-700 focus:outline-hidden"
                role="menu"
