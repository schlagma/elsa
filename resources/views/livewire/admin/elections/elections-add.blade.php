<div class="flex flex-col p-6 sm:p-8 pb-0! overflow-y-auto h-full">
    ...
    <div class="mt-6 mb-12">
        ...
        <div class="mt-6 grid sm:grid-cols-2 xl:grid-cols-3 gap-6">
            <flux:field>
                <flux:label for="checkboxPublic">{{ __('admin.electionIsPublic') }}</flux:label>
                <flux:checkbox wire:model="public" />
            </flux:field>
            <flux:field>
                <flux:label for="checkboxCandidatesExist">{{ __('admin.candidatesExist') }}</flux:label>
                <flux:checkbox wire:model="candidatesExist" />
            </flux:field>
            <flux:field>
                <flux:label for="checkboxAllVotesCounted">{{ __('admin.allVotesCounted') }}</flux:label>
