<div class="p-6 sm:p-8 overflow-y-auto h-full">
    <div class="xl:flex xl:items-center">
        ...
        <div class="mt-4 xl:ml-16 xl:mt-0 flex flex-col sm:flex-row whitespace-nowrap">
            <a wire:navigate href="{{ route('admin-faculties-add') }}" type="button" class="btn-primary">
                ...
                <div class="overflow-hidden shadow-xs ring-1 ring-black/5 sm:rounded-lg">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>@if(app()->getLocale() == "de"){{ json_decode($faculty->name)[0] }}@elseif(app()->getLocale() == "en"){{ json_decode($faculty->name)[1] }}@endif</td>
                                <td class="whitespace-nowrap text-right">
                                    <div class="relative inline-block text-left" x-data="{ dropdown: false }">                                            
                                        ...
                                        @if ($loop->index < count($faculties) - 2)
                                        ...
                                        @endif
                                            <div class="py-1">
                                                <a wire:navigate href="{{ route('admin-faculties-edit', ['id' => $faculty->id]) }}" class="text-zinc-800 dark:text-white group flex items-center px-4 py-2 border-0 hover:bg-zinc-200 dark:hover:bg-zinc-700 font-normal!">
