            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                ...
                <div class="overflow-hidden shadow-xs ring-1 ring-black/5 sm:rounded-lg">
                    <table>
                        <thead>
                            <tr>
                                <th scope="col" class="min-w-48">{{ __('admin.lastname') }}</th>
                                <th scope="col" class="min-w-48">{{ __('admin.firstname') }}</th>
                                <th scope="col" class="min-w-36">{{ __('admin.election') }}</th>
                                <th scope="col" class="min-w-56">{{ __('admin.faculty') }}</th>
                                <th scope="col" class="min-w-56">{{ __('admin.committee') }}</th>
                                <th scope="col" class="min-w-32">{{ __('admin.approvedShort') }}</th>
