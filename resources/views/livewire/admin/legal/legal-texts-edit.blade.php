    ...
    <div class="mt-6 mb-12">
        <div class="grid sm:grid-cols-2 gap-6">
            <div>
                ...
                <textarea wire:model="imprintDE" class="h-[15rem]"></textarea>
            </div>
            <div>
                <label>{{ __('admin.imprintEN') }}</label>
                <textarea wire:model="imprintEN" class="h-[15rem]"></textarea>
            </div>
        </div>
        ...
        <div class="mt-6 grid sm:grid-cols-2 gap-6">
            <div>
                ...
                <textarea wire:model="privacyDE" class="h-[15rem]"></textarea>
            </div>
            <div>
                <label>{{ __('admin.privacyPolicyEN') }}</label>
                <textarea wire:model="privacyEN" class="h-[15rem]"></textarea>
            </div>
        </div>
        ...
        <div class="mt-6 grid sm:grid-cols-2 gap-6">
            <div>
                ...
                <textarea wire:model="accessibilityDE" class="h-[15rem]"></textarea>
            </div>
            <div>
                <label>{{ __('admin.accessibilityStatementEN') }}</label>
                <textarea wire:model="accessibilityEN" class="h-[15rem]"></textarea>
            </div>
        </div>
    </div>
