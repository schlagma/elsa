<div class="p-6 sm:p-8 overflow-y-auto h-full">
    <div class="xl:flex xl:items-center">
        ...
        <div class="mt-4 xl:ml-16 xl:mt-0 flex flex-col sm:flex-row whitespace-nowrap">
            <a wire:navigate href="{{ route('admin-questions-add') }}" type="button" class="btn-primary">
            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                ...
                <div class="overflow-hidden shadow-sm ring-1 ring-black/5 sm:rounded-lg">
                    <table>
                        <thead>
                            <tr>
                                <th scope="col" class="min-w-[14rem]">{{ __('admin.election') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>@if(app()->getLocale() == "de"){{ json_decode($question->election)[0] }}@elseif(app()->getLocale() == "en"){{ json_decode($question->election)[1] }}@endif</td>
                                <td>@if(app()->getLocale() == "de"){{ json_decode($question->committee)[0] }}@elseif(app()->getLocale() == "en"){{ json_decode($question->committee)[1] }}@endif</td>
                                <td class="whitespace-nowrap text-right">
                                    <div class="relative inline-block text-left" x-data="{ dropdown: false }">                                            
                                        ...
                                        @if ($loop->index < count($questions) - 2)
                                        ...
                                        @endif
                                            <div class="py-1">
                                                <a wire:navigate href="{{ route('admin-questions-edit', ['id' => $question->id]) }}" class="text-zinc-800 dark:text-white group flex items-center px-4 py-2 border-0 hover:bg-zinc-200 dark:hover:bg-zinc-700 !font-normal">
