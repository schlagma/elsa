<div class="p-6 sm:p-8 overflow-y-auto h-full">
    <div class="xl:flex xl:items-center">
        ...
        <div class="mt-4 xl:ml-16 xl:mt-0 flex flex-col sm:flex-row whitespace-nowrap">
            <flux:button variant="primary" icon="plus" wire:navigate href="{{ route('admin-committees-add') }}">
        ...
        @if(count($committees) > 0)
            <flux:table>
                ...
                <flux:table.rows>
                    ...
                    <flux:table.row>
                        <flux:table.cell>@if(app()->getLocale() == "de"){{ json_decode($committee->name)[0] }}@elseif(app()->getLocale() == "en"){{ json_decode($committee->name)[1] }}@endif</flux:table.cell>
                        <flux:table.cell class="whitespace-nowrap text-right">
                            <flux:dropdown>
                                ...
                                <flux:menu>
                                    <flux:menu.item
                                        wire:navigate
                                        href="{{ route('admin-committees-edit', ['id' => $committee->id]) }}"
                                        icon="pencil"
                                    >
                                        {{ __('common.edit') }}
                                    </flux:menu.item>
